...
function wpr_theme_settings() {
	add_submenu_page(
		...
		__('WP Redirect Theme for Headless', 'wp-redirect'), // page title
...
function wpr_form_redirect_url() {
    ...
    <input class="setting-input" type="url" name="redirect-url" value="<?php echo $url; ?>" />
    <?php
}

function wpr_form_indexpage_heading() {
    $textpageHeading = esc_attr(get_option('indexpage-heading', '')); ?>
    <input class="setting-input" type="text" name="indexpage-heading" value="<?php echo $textpageHeading; ?>" />
    <?php
}
...
function wpr_form_indexpage_footer() {
    ...
    <input class="setting-input" type="text" name="indexpage-footer" value="<?php echo $textpageFooter; ?>" />
    <?php
}
...
function wpr_theme_settings_html() {
    ?>
    <div class="wrap">
        <h1><?php _e('WP Redirect Theme for Headless', 'wp-redirect');  ?></h1>
